...
/**
 * Bean de respuesta para la transacci&oacute;n <code>UGOC</code>
 *
...
@Multiformato(formatos = {FormatoUGFSGOC.class })
@RooJavaBean
@RooToString
@RooSerializable
public class RespuestaTransaccionUgoc implements MensajeMultiparte {
