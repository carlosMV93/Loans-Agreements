...
/**
 * Bean de respuesta para la transacci&oacute;n <code>UGOF</code>
 *
...
@Multiformato(formatos = {FormatoUGMOFS1.class })
@RooJavaBean
@RooToString
@RooSerializable
public class RespuestaTransaccionUgof implements MensajeMultiparte {
