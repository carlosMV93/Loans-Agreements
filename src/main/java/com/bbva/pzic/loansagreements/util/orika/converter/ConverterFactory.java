...
public interface ConverterFactory {
     ...
     */
    @Deprecated
    <S, D> void registerConverter(com.bbva.pzic.loansagreements.util.orika.converter.Converter<S, D> converter);
     ...
     */
    @Deprecated
    <S, D> void registerConverter(String converterId, com.bbva.pzic.loansagreements.util.orika.converter.Converter<S, D> converter);
