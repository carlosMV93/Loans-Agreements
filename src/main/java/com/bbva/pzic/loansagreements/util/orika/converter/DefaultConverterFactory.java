...
import com.bbva.pzic.loansagreements.util.orika.impl.Comparators;
import com.bbva.pzic.loansagreements.util.orika.impl.util.ClassUtil;
import com.bbva.pzic.loansagreements.util.orika.metadata.ConverterKey;
...
import com.bbva.pzic.loansagreements.util.orika.util.Cache;
import com.bbva.pzic.loansagreements.util.orika.util.CacheLRULinkedHashMap;
import com.bbva.pzic.loansagreements.util.orika.util.SortedSet;
...
public class DefaultConverterFactory implements ConverterFactory {
     ...
     */
    @Deprecated
    public <S, D> void registerConverter(com.bbva.pzic.loansagreements.util.orika.converter.Converter<S, D> converter) {
        
        registerConverter(new com.bbva.pzic.loansagreements.util.orika.converter.Converter.LegacyConverter<S, D>(converter));
    }
     ...
     */
    @Deprecated
    public <S, D> void registerConverter(String converterId, com.bbva.pzic.loansagreements.util.orika.converter.Converter<S, D> converter) {
        
        registerConverter(converterId, new com.bbva.pzic.loansagreements.util.orika.converter.Converter.LegacyConverter<S, D>(converter));
    }
}
