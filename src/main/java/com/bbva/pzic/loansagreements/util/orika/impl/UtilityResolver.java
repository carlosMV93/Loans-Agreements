...
import com.bbva.pzic.loansagreements.util.orika.OrikaSystemProperties;
import com.bbva.pzic.loansagreements.util.orika.constructor.ConstructorResolverStrategy;
import com.bbva.pzic.loansagreements.util.orika.constructor.SimpleConstructorResolverStrategy;
import com.bbva.pzic.loansagreements.util.orika.converter.ConverterFactory;
import com.bbva.pzic.loansagreements.util.orika.converter.DefaultConverterFactory;
import com.bbva.pzic.loansagreements.util.orika.impl.generator.CompilerStrategy;
import com.bbva.pzic.loansagreements.util.orika.impl.generator.JavassistCompilerStrategy;
import com.bbva.pzic.loansagreements.util.orika.metadata.ClassMapBuilderFactory;
import com.bbva.pzic.loansagreements.util.orika.property.ListPropertyResolverStrategy;
...
public abstract class UtilityResolver {
    ...
    public static ClassMapBuilderFactory getDefaultClassMapBuilderFactory() {
        return resolveUtility(OrikaSystemProperties.CLASSMAP_BUILDER_FACTORY, com.bbva.pzic.loansagreements.util.orika.metadata.ClassMapBuilder.Factory.class);
    }
