...
import com.bbva.pzic.loansagreements.util.orika.impl.GeneratedMapperBase;
import com.bbva.pzic.loansagreements.util.orika.impl.util.FieldListMapper;
...
public final class MapperGenerator {
    ...
    private static final String FIELD_LIST_MAPPER_CANONICAL_NAME = FieldListMapper.class.getCanonicalName();
    ...
    private Set<FieldMap> addMapMethod(GeneratedSourceCode code, boolean aToB, ClassMap<?, ?> classMap, UsedTypesContext usedTypes, UsedConvertersContext usedConverters, UsedMapperFacadesContext usedMappers,StringBuilder logDetails) throws CannotCompileException {
        ...
        //Declare FieldListMapper
        out.statement("%s fieldListMapper = new %s();", FIELD_LIST_MAPPER_CANONICAL_NAME, FIELD_LIST_MAPPER_CANONICAL_NAME);
