 ...
 *     "stack" by executing within a {@link com.bbva.pzic.loansagreements.util.orika.javolution.context.StackContext
 *     StackContext} and creating new instances with an  {@link 
 *     com.bbva.pzic.loansagreements.util.orika.javolution.context.ObjectFactory ObjectFactory}.
 *     It is the responsibility of the users to ensure 
 *     that "stack" objects are {@link com.bbva.pzic.loansagreements.util.orika.javolution.context.StackContext#outerCopy
 *     copied out} when
...
public interface ValueType extends Immutable {
     ...
     * and/or {@link com.bbva.pzic.loansagreements.util.orika.javolution.context.AllocatorContext context} (Javolution)
