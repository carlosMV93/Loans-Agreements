...
import com.bbva.pzic.loansagreements.util.orika.javolution.text.Text;
...
import com.bbva.pzic.loansagreements.util.orika.javolution.xml.sax.Attributes;
...
import com.bbva.pzic.loansagreements.util.orika.javolution.xml.stream.XMLStreamReaderImpl;
import com.bbva.pzic.loansagreements.util.orika.javolution.xml.stream.XMLStreamWriter;
import com.bbva.pzic.loansagreements.util.orika.javolution.xml.stream.XMLStreamWriterImpl;
...
public abstract class XMLFormat <T>  {
    ...
    public static final class InputElement {
         ...
         * {@link com.bbva.pzic.loansagreements.util.orika.javolution.xml.stream.XMLStreamReader#getElementText
         ...
         * {@link com.bbva.pzic.loansagreements.util.orika.javolution.text.TextFormat#getInstance TextFormat} is
    ...
    public static final class OutputElement {
         ...
         * com.bbva.pzic.loansagreements.util.orika.javolution.xml.stream.XMLStreamWriter#writeCharacters(CharSequence)
         ...
         * {@link com.bbva.pzic.loansagreements.util.orika.javolution.text.TextFormat#getInstance TextFormat}.
         * 
         * @param  name the name of the attribute.
         * @param  value the <code>Boolean</code> value for the specified attribute
