...
import com.bbva.pzic.loansagreements.util.orika.javolution.io.UTF8StreamReader;
...
public final class XMLStreamReaderImpl implements XMLStreamReader, Reusable {
     ...
     * @see    com.bbva.pzic.loansagreements.util.orika.javolution.io.UTF8StreamReader
     * @see    com.bbva.pzic.loansagreements.util.orika.javolution.io.UTF8ByteBufferReader
     * @see    com.bbva.pzic.loansagreements.util.orika.javolution.io.CharSequenceReader
     */
    ...
    private void increaseDataBuffer() {
        ...
        MemoryArea.getMemoryArea(this).executeInArea(new Runnable() {
            public void run() {
                ...
                com.bbva.pzic.loansagreements.util.orika.javolution.context.LogContext.info(new CharArray(
