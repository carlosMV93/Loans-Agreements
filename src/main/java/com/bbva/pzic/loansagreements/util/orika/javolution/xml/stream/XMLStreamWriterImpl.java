 ...
 */
package com.bbva.pzic.loansagreements.util.orika.javolution.xml.stream;
...
import com.bbva.pzic.loansagreements.util.orika.javax.realtime.MemoryArea;
import com.bbva.pzic.loansagreements.util.orika.javolution.context.ObjectFactory;
import com.bbva.pzic.loansagreements.util.orika.javolution.io.UTF8StreamWriter;
...
/**
 * <p> This class represents a  {@link com.bbva.pzic.loansagreements.util.orika.javolution.lang.Reusable reusable}
...
public final class XMLStreamWriterImpl implements XMLStreamWriter, Reusable {
     ...
     * @see    com.bbva.pzic.loansagreements.util.orika.javolution.io.UTF8StreamWriter
     * @see    com.bbva.pzic.loansagreements.util.orika.javolution.io.UTF8ByteBufferWriter
     * @see    com.bbva.pzic.loansagreements.util.orika.javolution.io.AppendableWriter
     */
    ...
    private final void write(Object csq, int start, int length,
        ...
        if (_index + length <= BUFFER_LENGTH) { // Enough buffer space.
            ...
            } else if (csq instanceof com.bbva.pzic.loansagreements.util.orika.javolution.text.Text) {
                ((com.bbva.pzic.loansagreements.util.orika.javolution.text.Text) csq).getChars(start, start
                        + length, _buffer, _index);
            } else if (csq instanceof com.bbva.pzic.loansagreements.util.orika.javolution.text.TextBuilder) {
                ((com.bbva.pzic.loansagreements.util.orika.javolution.text.TextBuilder) csq).getChars(start, start
                        + length, _buffer, _index);
            } else if (csq instanceof com.bbva.pzic.loansagreements.util.orika.javolution.text.CharArray) {
                ((com.bbva.pzic.loansagreements.util.orika.javolution.text.CharArray) csq).getChars(start, start
                        + length, _buffer, _index);
            } else {
