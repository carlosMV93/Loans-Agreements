...
import com.bbva.pzic.loansagreements.util.orika.impl.UtilityResolver;
import com.bbva.pzic.loansagreements.util.orika.property.PropertyResolver;
...
public class ClassMapBuilder<A, B> implements MappedTypePair<A, B> {
     ...
     * each time; instead, {@link com.bbva.pzic.loansagreements.util.orika.MapperFactory#classMap(Type, Type)} should
     ...
     */
    @Deprecated
    public final ClassMapBuilder<A, B> byDefault(com.bbva.pzic.loansagreements.util.orika.MappingHint hint0, com.bbva.pzic.loansagreements.util.orika.MappingHint... mappingHints) {
        com.bbva.pzic.loansagreements.util.orika.MappingHint[] hints = new com.bbva.pzic.loansagreements.util.orika.MappingHint[mappingHints.length + 1];
        hints[0] = hint0;
     ...
     */
    @Deprecated
    public final ClassMapBuilder<A, B> byDefault(com.bbva.pzic.loansagreements.util.orika.MappingHint[] mappingHints) {
        ...
        for (final String propertyName : aProperties.keySet()) {
            if (!propertiesCacheA.contains(propertyName)) {
                if (bProperties.containsKey(propertyName)) {
                    ...
                    for (com.bbva.pzic.loansagreements.util.orika.MappingHint hint : mappingHints) {
     ...
     * @param bType
     * @return
     * @deprecated use {@link com.bbva.pzic.loansagreements.util.orika.MapperFactory#classMap(Class, Class)} instead
     */
     ...
     * @param bType
     * @return
     * @deprecated use {@link com.bbva.pzic.loansagreements.util.orika.MapperFactory#classMap(Type, Type)} instead
     */
     ...
     * @param bType
     * @return
     * @deprecated use {@link com.bbva.pzic.loansagreements.util.orika.MapperFactory#classMap(Class, Type)} instead
     */
     ...
     * @param bType
     * @return
     * @deprecated use {@link com.bbva.pzic.loansagreements.util.orika.MapperFactory#classMap(Type, Class)} instead
     */
